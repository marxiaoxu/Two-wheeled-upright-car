...
/*  r     h      N                  beta_01   beta_02    beta_03     b0     beta_0  beta_1     beta_2     N1     C    alpha1  alpha2  zeta       b*/
 {3000000000 ,0.004 , 5,               300,      7000,      1000,      20,    0.95,   1.5,      0.001,      200,    5,    0.7,   1.0,    0.01,    0.1},
 {1000000000 ,0.004 , 3,               300,      7000,      1000,      20,    0.85,   1.5,      0.0003,      200,    5,    0.8,   1.2,    0.03,    0.1},
 {1000000000 ,0.01 , 1,               300,      4000,      10000,     100,   0.2,    1.2,      0.0010,      5,      5,    0.8,   1.5,    0.03,    0.05}
};
...
{
    int16_t output=0;
    if(Input>(float)(1E-6)) output=1;
    else if(Input<-(float)1E-6) output=-1;
    else output=0;
    return output;
}
