...
/**************修改如下值*******************/
#define In 10    //输入层In个节点   11 
#define Hide 48  //隐藏层Hide个节点  30000 
#define Out 1   //输出层Out个节点4691   2114 
#define N  5520//每次训练N组数据  //2760 
#define Ntest  30  //每次测试Ntest组数据
#define Err_max  0.00001 //允许的误差精度0.000001 
#define rate  0.0001//学习速率0.001 
#define In_divisor  1.0 //输入除数 保持所有输入数据在-1~1内
